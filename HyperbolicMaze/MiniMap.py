...
class MiniMap:
    ...
    def __init__(self, screen_placement):
        self.screen_placement = screen_placement

    def stereographic_projection(self, x, y):
...
if __name__ == '__main__':
    ...
    mapped_line = np.array([mini_map.stereographic_projection(x, y) for x, y in line])
    ...
    while running:
        ...
        mapped_line = [mini_map.stereographic_projection(x, y) for x, y in shifted_line]
        #screen.fill((0,0,0))
